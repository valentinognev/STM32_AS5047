...
#define START_LOG_Pin GPIO_PIN_10
#define START_LOG_GPIO_Port GPIOE
#define START_LOG_EXTI_IRQn EXTI15_10_IRQn
#define ENCODER_I_Pin GPIO_PIN_11
#define ENCODER_I_GPIO_Port GPIOD
#define ENCODER_I_EXTI_IRQn EXTI15_10_IRQn
